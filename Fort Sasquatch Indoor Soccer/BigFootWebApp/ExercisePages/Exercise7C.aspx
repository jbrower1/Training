<%@ Page Title="Team Look Up" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Exercise7C.aspx.cs" Inherits="BigFootWebApp.ExercisePages.Exercise7C" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-header">
        <h1>Client Server Query - Team Series</h1>
    </div>
