...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            DataSourceID="ProductListODS" AllowPaging="True">
              <Columns>
                ...
                <asp:TemplateField HeaderText="Supplier">
                    <ItemTemplate>
                        <asp:DropDownList ID="SupplierListGV" 
                            runat="server" 
                ...
                <asp:TemplateField HeaderText="Category">
                    <ItemTemplate>
                        <asp:DropDownList ID="CategoryListGV" 
                            runat="server" 
    ...
    <asp:ObjectDataSource ID="CategoryListODS" runat="server" OldValuesParameterFormatString="original_{0}" 
        SelectMethod="Category_List" TypeName="NorthwindSystem.BLL.CategoryController"></asp:ObjectDataSource> <!-- Can be put after anything, not in something -->
    ...
    <asp:ObjectDataSource ID="ProductListODS" runat="server" OldValuesParameterFormatString="original_{0}" 
        SelectMethod="Products_GetByCategory" TypeName="NorthwindSystem.BLL.ProductController">
        <SelectParameters>
